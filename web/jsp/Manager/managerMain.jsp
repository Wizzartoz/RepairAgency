            ...
            <div class="col-6">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="ManagerServlet?status=progress">in progress</a></li>
                        <li><a class="dropdown-item" href="ManagerServlet?status=done">done</a></li>
                        <li><a class="dropdown-item" href="ManagerServlet?status=consideration">under consideration</a>
                        </li>
                    </ul>
                </div>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="ManagerServlet?sort=date">sorting by date</a></li>
                        <li><a class="dropdown-item" href="ManagerServlet?sort=status">sorting by complication
                            status</a></li>
                        <li><a class="dropdown-item" href="ManagerServlet?sort=payStatus">sorting by payment status</a>
                        </li>
                        <li><a class="dropdown-item" href="ManagerServlet?sort=price&order=increase">sorting by price
                            increase</a></li>
                        <li><a class="dropdown-item" href="ManagerServlet?sort=price&order=decrease">sorting by
                            decreasing price</a></li>
                    </ul>
                </div>
                <div class="btn-group">
                    <button type="button" class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown"
                    ...
                    <ul class="dropdown-menu">
                        <c:forEach var="user" items="${requestScope.users}">
                            <li><a class="dropdown-item" href="ManagerServlet?master=${user.login}">${user.login}</a>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
                <ul class="pagination my-2">
                    <c:forEach var="i" begin="0" end="${requestScope.pages}">
                        <li class="page-item"><a style="color: #1c1c1c" class="page-link"
                                                 href="${pageContext.request.contextPath}/ManagerServlet?offset=${i*8}">${i+1}</a></li>
                    </c:forEach>
                </ul>
