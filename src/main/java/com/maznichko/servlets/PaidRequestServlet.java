...
import com.maznichko.services.Paid;
...
@WebServlet(name = "PaidRequestServlet", value = "/PaidRequestServlet")
public class PaidRequestServlet extends HttpServlet {
    @Override
